...
class CreateDoctorScreen extends StatefulWidget {
  final String adminToken; // Token của admin để xác thực

  const CreateDoctorScreen({super.key, required this.adminToken});
...
class _CreateDoctorScreenState extends State<CreateDoctorScreen> {
  ...
  bool _loading = false;
  String? _message; // hiển thị cả lỗi hoặc thành công
  ...
  Future<void> _createDoctor() async {
    ...
    try {
      // ✅ Gửi thêm specialty và department
      final result = await _adminService.createDoctor(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            // ✅ Thêm trường Chuyên khoa
            TextFormField(
              controller: _specialtyController,
              decoration: const InputDecoration(
                labelText: "Chuyên khoa (ví dụ: Tim mạch)",
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                labelText: "Khoa công tác (ví dụ: Khoa Nội)",
